...
import com.inmar.sku.config.audit.AuditEventConverter;
import com.inmar.sku.domain.PersistentAuditEvent;
...
import static com.inmar.sku.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
